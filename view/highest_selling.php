    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_specdateGroMany1c('sales', 'item', 'quantity', 'total_amount', 'start_dates', $start_day, 'sales_status', 2, 'store', $store, 'item', 'SUM(total_amount)');
