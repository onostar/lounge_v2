...
?>
    <div class="info"></div>
    <button class="page_navs" id="back" onclick="showPage('guest_refund.php')"><i class="fas fa-angle-double-left"></i> Back</button>
    <div class="add_user_form" style="width:50%; margin:0">
        <h3 style="background:var(--tertiaryColor)">Refund Amount to <?php echo strtoupper($full_name)?></h3>
        ...
        <section class="addUserForm">
            ...
            <div class="inputs">
                <button type="submit" id="add_cat" name="add_cat" onclick="refund()">Refund <i class="fas fa-spin-reverse"></i></button>
            </div>
    </section>    
    </div>
<?php }?>
