    ...
    <table id="check_out_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_curdateGreCon('check_ins', 'check_out_date','guest_status', 1);
            ...
            <td style="text-align:center; color:red;"><?php echo $n?></td>
                ...
                <td>
                    <a style="background:var(--otherColor); color:#fff; padding:5px; border-radius:10px" href="javascript:void(0)" title="View guest details" onclick="showPage('guest_details.php?guest_id=<?php echo $detail->checkin_id?>')">view <i class="fas fa-eye"></i></a>
                </td>
