...
?>
<div id="revenueReport" class="displays management" style="width:100%; margin:0!important">
...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_specDateCon('payments', 'start_dates', $start_day, 'payment_mode','Cash');
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_specdate2Con('payments', 'amount_paid', 'start_dates', $start_day, 'payment_mode', 'Cash');
