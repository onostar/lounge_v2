...
<div id="revenueReport" class="displays management" style="width:100%!important">
    ...
    <div class="general_revenue">
        ...
        <div class="displays allResults new_data" id="revenue_report">
            <h2>Guest Deposit Report for today</h2>
            <hr>
            <div class="search">
            ...
            <table id="data_table" class="searchTable">
                ...
                <tbody>
                    <?php
                        ...
                        $details = $get_users->fetch_details_curdate('deposits', 'date(post_date)');
            ...
            <?php
                ...
                if(gettype($details) == "array"){
                    ...
                    $credits = $get_credit->fetch_sum_curdate('deposits', 'amount', 'post_date');
