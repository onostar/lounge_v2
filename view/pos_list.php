...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_specDateCon('payments', 'start_dates', $start_day, 'payment_mode','POS');
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_specdate2Con('payments', 'amount_paid', 'start_dates', $start_day, 'payment_mode', 'POS');
