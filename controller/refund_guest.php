<?php
    ...
    $invoice = "RF".$todays_date.$user.$ran_num;
    ...
    if($update){
        $add_data = new add_data('refunds',$data);
        $add_data->create_data();
        echo "<div class='succeed'><p><i class='fas fa-thumbs-up'></i></p><p>Guest Refunded successfully!</p></div>";
    }
