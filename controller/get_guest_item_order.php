<?php
    ...
    <div class="add_user_form priceForm" style="width:100%; margin:5px 0;">
        <h3 style="background:var(--primaryColor); text-align:left">Return <?php echo strtoupper($name)?> item from Invoice (<?php echo $row->invoice?>)</span></h3>
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="gap:0; justify-content:none">
                <div class="data item_head" style="width:20%;">
                    <h4>Qty ordered => <?php  echo $row->quantity?></h4>
                </div>
                ...
                <div class="data" style="width:auto;  margin:0;">
                    <button type="submit" id="return_sales" name="return_sales" onclick="returnGuestItem('<?php echo $check_id?>')" style="background:green;font-size:.8rem"> Return</button>
