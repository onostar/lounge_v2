    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_2dateGroMany1c('sales', 'item', 'quantity', 'total_amount', 'date(start_dates)', 'sales_status', 2, 'store', $store, 'item', 'SUM(total_amount)', $from, $to);
