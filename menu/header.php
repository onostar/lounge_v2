    ...
    <div class="main_body">
        ...
        <header id="mainHeader" class="new_header" style="position:fixed;">
            ...
            <nav id="navigation">
                <ul>
                    <li>
                        <a href="food_menu.php" title="Food menu">Food Menu <i class="fas fa-utensils"></i></a>
                    </li>
                    <li>
                        <a href="drink_menu.php" title="Drinks and beverages">Drinks <i class="fas fa-cocktail"></i></a>
                    </li>
